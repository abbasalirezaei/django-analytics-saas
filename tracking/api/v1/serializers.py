...
from ...models import Website, Session, PageView, Event
...
class PageViewSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PageView
        fields = [
            'domain', 'session_id', 'page_url', 'page_title', 
            'referrer', 'load_time', 'user_agent', 'ip_address'
        ]
...
class EventSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Event
        fields = [
            'domain', 'session_id', 'event_name', 'event_data',
...
class SessionStartSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Session
        fields = [
            'domain', 'session_id', 'user_agent', 'ip_address',
            'country', 'browser', 'device_type'
        ]
